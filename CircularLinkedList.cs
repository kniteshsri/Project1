...
class Node
    ...
    class CircularList
    {
        ...
        public void addNode()/*Adds a node in the list*/
        {
            ...
            newnode.name = nm;
            if (LAST == null)/*Checks if the list is empty*/
            {
                newnode.next = LAST;
                LAST = newnode;
                LAST.next = LAST;
            ...
            else if (rollNo <= LAST.next.rollNumber)/*If the new node is to be inserted at the beginning of the list*/
            {
            ...
            for (previous = current = LAST.next; rollNo >= current.rollNumber; previous = current, current = current.next)
            {
                ...
                if (previous == LAST)/*If the element is to be added at the end of the list*/
                {
                    newnode.next = LAST.next;
                    LAST.next = newnode;
                    LAST = newnode;
